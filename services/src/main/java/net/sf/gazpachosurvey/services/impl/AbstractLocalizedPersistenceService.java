...
public abstract class AbstractLocalizedPersistenceService<L extends Localizable<LS, TR>, D extends IdentifiableLocalizable<LSD>, TR extends Translation<LS>, LS extends LanguageSettings, LSD extends LanguageSettings>
    ...
    protected AbstractLocalizedPersistenceService(
            ...
            Class<LS> languageSettingsClazz,
            Class<LSD> languageSettingsDtoClazz,
    ...
    public Set<Language> translationsSupported(Integer entityId) {
        ...
        TR translationExample = translationBuilder.translatedEntityId(entityId)
                .build();

        List<TR> supportedLanguages = translationRepository.findByExample(
                translationExample, new SearchParameters());
