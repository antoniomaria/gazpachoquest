...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, status VARCHAR(255), DESCRIPTION LONGVARCHAR NOT NULL, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT LONGVARCHAR, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, DESCRIPTION LONGVARCHAR NOT NULL, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT LONGVARCHAR, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
...
ALTER TABLE users ADD CONSTRAINT UNQ_users_1 UNIQUE (acronym);
ALTER TABLE users ADD CONSTRAINT UNQ_users_2 UNIQUE (api_key);
...
-- Dynamic tables
CREATE TABLE questionnair_answers_7(id INTEGER NOT NULL, q1 VARCHAR(255), q2 VARCHAR(255), q3 integer, q4 VARCHAR(1000000), q5 VARCHAR(255), q6 VARCHAR(255), q7_1 VARCHAR(255), q7_2 VARCHAR(255), q7_3 VARCHAR(255), q7_4 VARCHAR(255), q8_o1 BOOLEAN, q8_o2 BOOLEAN, q8_o3 BOOLEAN, q8_o4 BOOLEAN, PRIMARY KEY (id));
