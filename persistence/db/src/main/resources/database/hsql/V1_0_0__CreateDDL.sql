CREATE TABLE invitation (id INTEGER NOT NULL, type VARCHAR(20), status VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, RESEARCH_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, RESPONDENT_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE breadcrumb (id INTEGER NOT NULL, type VARCHAR(31), created_date timestamp, last BOOLEAN, last_modified_date timestamp, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIR_ID INTEGER, PARENT_ID INTEGER, QUESTION_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_breadcrumb_group INTEGER, navigation_order INTEGER, rendering_mode VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE question (id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, other_allowed BOOLEAN default false NOT NULL, required BOOLEAN default false NOT NULL, type VARCHAR(255) NOT NULL, help VARCHAR(255), title VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARENT_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_subquestions INTEGER, order_in_questiongroup INTEGER, PRIMARY KEY (id));
CREATE TABLE question_group (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, randomization_enabled BOOLEAN default false NOT NULL, description LONGVARCHAR, title VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, order_in_questionnair INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible BOOLEAN default true NOT NULL, question_group_info_visible BOOLEAN default true NOT NULL, questions_per_page INTEGER, randomization_strategy VARCHAR(255) default 'N' NOT NULL, status VARCHAR(255), welcome_visible BOOLEAN default true NOT NULL, description LONGVARCHAR NOT NULL, end_text LONGVARCHAR, title VARCHAR(255) NOT NULL, welcome_text LONGVARCHAR NOT NULL, rendering_mode varchar(255) default 'GBG' not null, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE users (id INTEGER NOT NULL, api_key VARCHAR(255) NOT NULL, attributes VARCHAR(255), created_date timestamp, email VARCHAR(255) NOT NULL, gender VARCHAR(255), given_names VARCHAR(255) NOT NULL, last_modified_date timestamp, password VARCHAR(255), preferred_language VARCHAR(255), secret VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, username VARCHAR(255), CREATEDBY_ID INTEGER, DEFAULTROLE_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, description LONGVARCHAR NOT NULL, end_text LONGVARCHAR, title VARCHAR(255) NOT NULL, welcome_text LONGVARCHAR NOT NULL, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
