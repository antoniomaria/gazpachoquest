CREATE TABLE browsed_element (id INTEGER NOT NULL, type VARCHAR(31), created_date timestamp, last TINYINT(1) default 0, last_modified_date timestamp, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIR_ID INTEGER, QUESTION_ID INTEGER, QUESTIONGROUP_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE participant (id INTEGER NOT NULL, created_date timestamp, email VARCHAR(255), firstname VARCHAR(255) NOT NULL, gender VARCHAR(255), last_modified_date timestamp, lastname VARCHAR(255) NOT NULL, prefered_language VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE question (id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, required TINYINT(1) default 0, type VARCHAR(255) NOT NULL, TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARENT_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_subquestions INTEGER, order_in_questiongroup INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, status VARCHAR(255), DESCRIPTION LONGTEXT NOT NULL, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT LONGTEXT, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE users (id INTEGER NOT NULL, created_date timestamp, email VARCHAR(255) NOT NULL UNIQUE, first_name VARCHAR(255) NOT NULL, last_modified_date timestamp, last_name VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, DESCRIPTION LONGTEXT NOT NULL, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT LONGTEXT, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_answers_6(id INTEGER NOT NULL, q1 VARCHAR(255), q2 VARCHAR(255), q3 integer, q4 text, q5 VARCHAR(255), q6 VARCHAR(255), q7_1 VARCHAR(255), q7_2 VARCHAR(255), q7_3 VARCHAR(255), q7_4 VARCHAR(255), q8_o1 TINYINT(1) default 0, q8_o2 TINYINT(1) default 0, q8_o3 TINYINT(1) default 0, q8_o4 TINYINT(1) default 0, PRIMARY KEY (id));
...
ALTER TABLE participant ADD CONSTRAINT FK_participant_LASTMODIFIEDBY_ID FOREIGN KEY (LASTMODIFIEDBY_ID) REFERENCES users (id);
ALTER TABLE participant ADD CONSTRAINT FK_participant_CREATEDBY_ID FOREIGN KEY (CREATEDBY_ID) REFERENCES users (id);
...
ALTER TABLE questionnair ADD CONSTRAINT FK_questionnair_PARTICIPANT_ID FOREIGN KEY (PARTICIPANT_ID) REFERENCES participant (id);
...
ALTER TABLE invitation ADD CONSTRAINT fk_invitation_participant_id FOREIGN KEY (participant_id) REFERENCES participant (id);
ALTER TABLE invitation ADD CONSTRAINT fk_invitation_study_id FOREIGN KEY (study_id) REFERENCES study (id);
