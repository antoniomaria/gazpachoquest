...
CREATE TABLE breadcrumb (id INTEGER NOT NULL, type VARCHAR(31), created_date timestamp, last TINYINT(1) default 0, last_modified_date timestamp, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIR_ID INTEGER, PARENT_ID INTEGER, QUESTION_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_breadcrumb_group INTEGER, navigation_order INTEGER, rendering_mode VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE question_group (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, randomization_enabled TINYINT(1) default 0 NOT NULL, description LONGTEXT, title VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, order_in_questionnair INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible TINYINT(1) default 0 NOT NULL, question_group_info_visible TINYINT(1) default 0 NOT NULL, questions_per_page INTEGER, randomization_strategy VARCHAR(255) default 'N' NOT NULL, status VARCHAR(255), welcome_visible TINYINT(1) default 0 NOT NULL, description LONGTEXT NOT NULL, end_text LONGTEXT, title VARCHAR(255) NOT NULL, welcome_text LONGTEXT NOT NULL, rendering_mode varchar(255) default 'GBG' not null, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
ALTER TABLE questionnair_definition_translation ADD CONSTRAINT qstnnairdefinitiontranslationQSTONNAIRDEFINITIONID FOREIGN KEY (QUESTIONNAIRDEFINITION_ID) REFERENCES questionnair_definition (id);
...
-- Dynamic tables
CREATE TABLE questionnair_answers_12 (id INTEGER NOT NULL, q1 VARCHAR(255), q10 VARCHAR(255), q11 VARCHAR(255), q12 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4_o1 BIT(1), q4_o2 BIT(1), q4_o3 BIT(1),q4_o4 BIT(1), q5 VARCHAR(255), q6 VARCHAR(255), q7_o1 BIT(1),q7_o2 BIT(1),q7_o3 BIT(1),  q7_o4 BIT(1),q8 INTEGER, q9 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE questionnair_answers_121(id INTEGER NOT NULL, q1 VARCHAR(255), q10 VARCHAR(255), q11 VARCHAR(255), q12 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4_o1 BIT(1), q4_o2 BIT(1), q4_o3 BIT(1),q4_o4 BIT(1), q5 VARCHAR(255), q6 VARCHAR(255), q7_o1 BIT(1),q7_o2 BIT(1),q7_o3 BIT(1),  q7_o4 BIT(1),q8 INTEGER, q9 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE questionnair_answers_230(id INTEGER NOT NULL, q1 VARCHAR(255), q10 VARCHAR(255), q11 VARCHAR(255), q12 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4_o1 BIT(1), q4_o2 BIT(1), q4_o3 BIT(1),q4_o4 BIT(1), q5 VARCHAR(255), q6 VARCHAR(255), q7_o1 BIT(1),q7_o2 BIT(1),q7_o3 BIT(1),  q7_o4 BIT(1),q8 INTEGER, q9 VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE questionnair_answers_339(id INTEGER NOT NULL, q1 VARCHAR(255), q10 VARCHAR(255), q11 VARCHAR(255), q12 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4_o1 BIT(1), q4_o2 BIT(1), q4_o3 BIT(1),q4_o4 BIT(1), q5 VARCHAR(255), q6 VARCHAR(255), q7_o1 BIT(1),q7_o2 BIT(1),q7_o3 BIT(1),  q7_o4 BIT(1),q8 INTEGER, q9 VARCHAR(255), PRIMARY KEY (id));
