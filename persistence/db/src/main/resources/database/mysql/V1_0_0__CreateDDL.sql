...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible TINYINT(1) default 0 NOT NULL, question_group_info_visible TINYINT(1) default 0 NOT NULL, questions_per_page INTEGER, randomization_strategy VARCHAR(255) default 'N' NOT NULL, status VARCHAR(255), welcome_visible TINYINT(1) default 0 NOT NULL, description LONGTEXT NOT NULL, end_text LONGTEXT, title VARCHAR(255) NOT NULL, welcome_text LONGTEXT NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
