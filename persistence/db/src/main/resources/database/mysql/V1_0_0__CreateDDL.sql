...
CREATE TABLE users (id INTEGER NOT NULL, acronym VARCHAR(255) NOT NULL UNIQUE, api_key VARCHAR(255) NOT NULL UNIQUE, created_date timestamp, email VARCHAR(255) NOT NULL, gender VARCHAR(255), given_names VARCHAR(255) NOT NULL, last_modified_date timestamp, prefered_language VARCHAR(255), surname VARCHAR(255) NOT NULL, username VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE role (id INTEGER NOT NULL, description VARCHAR(255), name VARCHAR(255), scope VARCHAR(255) NOT NULL, PRIMARY KEY (id));
...
-- Dynamic tables
CREATE TABLE questionnair_answers_120 (id INTEGER NOT NULL, q1_1 VARCHAR(255), q1_2 VARCHAR(255), q1_3 VARCHAR(255),  q1_4 VARCHAR(255), q2_1 VARCHAR(255),q2_2 VARCHAR(255), q2_3 VARCHAR(255), q2_4 VARCHAR(255), q2_5 VARCHAR(255), q2_6 VARCHAR(255), q3 VARCHAR(255), PRIMARY KEY (id));

CREATE TABLE questionnair_answers_7 ( id INTEGER NOT NULL, q1 VARCHAR(255), q10 VARCHAR(255), q11 VARCHAR(255), q12 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4_o1 BIT(1), q4_o2 BIT(1), q4_o3 BIT(1),q4_o4 BIT(1), q5 VARCHAR(255), q6 VARCHAR(255), q7_o1 BIT(1),q7_o2 BIT(1),q7_o3 BIT(1),  q7_o4 BIT(1),q8 INTEGER, q9 VARCHAR(255), PRIMARY KEY (id));
