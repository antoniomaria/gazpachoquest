...
-- Dynamic tables
CREATE TABLE questionnair_answers_7(id INTEGER NOT NULL, q1 VARCHAR(255), q2 VARCHAR(255), q3 INTEGER, q4 text, q5 VARCHAR(255), q6 VARCHAR(255), q7_1 VARCHAR(255), q7_2 VARCHAR(255), q7_3 VARCHAR(255), q7_4 VARCHAR(255), q8_o1 BIT(1), q8_o2 BIT(1), q8_o3 BIT(1), q8_o4 BIT(1), PRIMARY KEY (id));
