...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible BOOLEAN NOT NULL default true, question_group_info_visible BOOLEAN NOT NULL default true, questions_per_page INTEGER, randomization_strategy VARCHAR(255) NOT NULL default 'N', status VARCHAR(255), welcome_visible BOOLEAN NOT NULL default true, DESCRIPTION TEXT NOT NULL, ENDTEXT TEXT, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT TEXT NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
