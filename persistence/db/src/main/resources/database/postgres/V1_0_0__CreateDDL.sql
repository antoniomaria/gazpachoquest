...
CREATE TABLE question (id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, other_allowed BOOLEAN default false, required BOOLEAN default false, type VARCHAR(255) NOT NULL, HELP VARCHAR(255), TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARENT_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_subquestions INTEGER, order_in_questiongroup INTEGER, PRIMARY KEY (id));
CREATE TABLE question_group (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, randomization_enabled BOOLEAN default false, DESCRIPTION TEXT, TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, order_in_questionnair INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible BOOLEAN default true, question_group_info_visible BOOLEAN default true, randomization_enabled BOOLEAN default false, status VARCHAR(255), welcome_visible BOOLEAN default true, DESCRIPTION TEXT NOT NULL, ENDTEXT TEXT, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT TEXT, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
