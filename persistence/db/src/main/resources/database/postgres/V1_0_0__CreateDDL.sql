...
CREATE TABLE browsed_element (id INTEGER NOT NULL, type VARCHAR(31), created_date timestamp, last BOOLEAN default false, navigation_order INTEGER, last_modified_date timestamp, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIR_ID INTEGER, QUESTION_ID INTEGER, QUESTIONGROUP_ID INTEGER, PRIMARY KEY (id));
