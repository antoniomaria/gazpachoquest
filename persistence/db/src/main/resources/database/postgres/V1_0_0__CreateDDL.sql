...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible BOOLEAN default true, question_group_info_visible BOOLEAN default true, RANDOMIZATION_STRATEGY VARCHAR(255), status VARCHAR(255), welcome_visible BOOLEAN default true, DESCRIPTION TEXT NOT NULL, ENDTEXT TEXT, TITLE VARCHAR(255) NOT NULL, WELCOMETEXT TEXT, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
