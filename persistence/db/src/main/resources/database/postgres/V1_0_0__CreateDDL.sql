...
CREATE TABLE question (id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, other_allowed BOOLEAN NOT NULL default false, required BOOLEAN NOT NULL default false, type VARCHAR(255) NOT NULL, HELP VARCHAR(255), TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARENT_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_subquestions INTEGER, order_in_questiongroup INTEGER, PRIMARY KEY (id));
CREATE TABLE question_group (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, randomization_enabled BOOLEAN NOT NULL default false, DESCRIPTION TEXT, TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, order_in_questionnair INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, progress_visible BOOLEAN NOT NULL default true, question_group_info_visible BOOLEAN NOT NULL default true, questions_per_page INTEGER, randomization_strategy VARCHAR(255) NOT NULL default 'N', status VARCHAR(255), welcome_visible BOOLEAN NOT NULL default true, DESCRIPTION TEXT NOT NULL, end_text TEXT, TITLE VARCHAR(255) NOT NULL, welcome_text TEXT NOT NULL, rendering_mode varchar(255) default 'GBG' not null, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE users (id INTEGER NOT NULL, password VARCHAR(255), defaultrole_id INTEGER, api_key VARCHAR(255) NOT NULL UNIQUE, attributes hstore, secret VARCHAR(255) NOT NULL, created_date timestamp, email VARCHAR(255) NOT NULL, gender VARCHAR(255), given_names VARCHAR(255) NOT NULL, last_modified_date timestamp, preferred_language VARCHAR(255), surname VARCHAR(255) NOT NULL, username VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE question_group_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, description TEXT, title VARCHAR(255) NOT NULL, QUESTIONGROUP_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE questionnair_definition_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, description TEXT NOT NULL, end_text TEXT, title VARCHAR(255) NOT NULL, welcome_text TEXT NOT NULL, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
...
ALTER TABLE breadcrumb ADD CONSTRAINT FK_breadcrumb_QUESTIONNAIR_ID FOREIGN KEY (QUESTIONNAIR_ID) REFERENCES questionnair (id);
ALTER TABLE breadcrumb ADD CONSTRAINT FK_breadcrumb_QUESTIONGROUP_ID FOREIGN KEY (QUESTIONGROUP_ID) REFERENCES question_group (id);
