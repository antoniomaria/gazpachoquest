...
public class QuestionnairAnswersRepositoryTest {
	...
	public void saveTest() {
		...
		QuestionnairDefinition questionnairDefinition = questionnair
				.getQuestionnairDefinition();

		QuestionnairAnswers questionnairAnswers = QuestionnairAnswers.with()
				.id(answersId).build();
		...
		questionnairAnswers.setAnswer("q4",
				ArrayUtils.toObject(longAnswer.toCharArray()));
		...
		questionnairAnswers = repository.save(questionnairDefinition.getId(),
				questionnairAnswers);
		...
		questionnairAnswers = repository.save(questionnairDefinition.getId(),
				questionnairAnswers);
		assertThat(questionnairAnswers.getAnswer("q1")).isEqualTo(
