...
public class QuestionnaireDefinitionPermission extends AbstractPermission<QuestionnaireDefinition> {
    ...
    public QuestionnaireDefinitionPermission(Integer id, User user, Role role, Integer mask,
            QuestionnaireDefinition target) {
    ...
    public static class Builder {
        ...
        private Role role;
        private int mask;
        private QuestionnaireDefinition target;
        ...
        public Builder target(QuestionnaireDefinition target) {
            this.target = target;
            return this;
        }
        ...
        public QuestionnaireDefinitionPermission build() {
            return new QuestionnaireDefinitionPermission(id, user, role, mask, target);
        }
    }
