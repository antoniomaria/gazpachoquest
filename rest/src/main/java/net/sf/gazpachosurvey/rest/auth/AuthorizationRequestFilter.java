...
public class AuthorizationRequestFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext)
        ...
        if (method.equals("GET")
                && (requestUrl.equals("application.wadl") || requestUrl
        ...
        AuthorizationRequestContext authRequestContext = AuthorizationRequestContext
                .with().httpMethod(method).requestUrl(requestUrl)
                .authorizationToken(authToken).build();
