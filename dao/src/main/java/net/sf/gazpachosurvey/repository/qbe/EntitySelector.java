 ...
 */
public class EntitySelector<E, T extends Identifiable<TPK>, TPK extends Serializable>
     ...
     */
    static public <E2, T2 extends Identifiable<TPK2>, TPK2 extends Serializable> EntitySelector<E2, T2, TPK2> entitySelector(
