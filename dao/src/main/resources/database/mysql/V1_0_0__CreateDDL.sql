...
CREATE TABLE surveys (id INTEGER AUTO_INCREMENT NOT NULL, description VARCHAR(255), name VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE survey_runnings (id INTEGER AUTO_INCREMENT NOT NULL, name VARCHAR(255), SURVEY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE survey_translations (id INTEGER AUTO_INCREMENT NOT NULL, language VARCHAR(255), text VARCHAR(255), SURVEY_ID INTEGER, PRIMARY KEY (id));
