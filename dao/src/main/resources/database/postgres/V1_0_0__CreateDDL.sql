CREATE TABLE anonymous_invitation (id INTEGER NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE mail_message_template (id INTEGER NOT NULL, created_date timestamp, from_address VARCHAR(255), language VARCHAR(255) NOT NULL, last_modified_date timestamp, reply_to VARCHAR(255), type VARCHAR(255) NOT NULL, BODY TEXT, SUBJECT VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE participant (id INTEGER NOT NULL, created_date timestamp, email VARCHAR(255), firstname VARCHAR(255) NOT NULL, gender INTEGER, last_modified_date timestamp, lastname VARCHAR(255) NOT NULL, prefered_language INTEGER, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE personal_invitation (id INTEGER NOT NULL, PARTICIPANT_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE question (id INTEGER NOT NULL, code VARCHAR(255) NOT NULL, created_date timestamp, is_required BOOLEAN, language VARCHAR(255) NOT NULL, last_modified_date timestamp, type VARCHAR(255) NOT NULL, TITLE VARCHAR(255) NOT NULL, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARENT_ID INTEGER, QUESTIONGROUP_ID INTEGER, order_in_subquestions INTEGER, order_in_questiongroup INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair (id INTEGER NOT NULL, answers_id INTEGER, created_date timestamp, last_modified_date timestamp, status VARCHAR(255), submit_date timestamp, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PARTICIPANT_ID INTEGER, QUESTIONNAIRDEFINITION_ID INTEGER, STUDY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE questionnair_definition (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, status VARCHAR(255), DESCRIPTION TEXT, TITLE VARCHAR(255), WELCOMETEXT TEXT, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE mail_message_template_translation (id INTEGER NOT NULL, created_date timestamp, language VARCHAR(255) NOT NULL, last_modified_date timestamp, BODY TEXT, SUBJECT VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, MAILMESSAGETEMPLATE_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questionnair_definition_translation (id INTEGER NOT NULL, language VARCHAR(255) NOT NULL, DESCRIPTION TEXT, TITLE VARCHAR(255), WELCOMETEXT TEXT, QUESTIONNAIRDEFINITION_ID INTEGER, PRIMARY KEY (id));
...
ALTER TABLE personal_invitation ADD CONSTRAINT FK_personal_invitation_PARTICIPANT_ID FOREIGN KEY (PARTICIPANT_ID) REFERENCES participant (id);
