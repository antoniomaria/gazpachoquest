...
CREATE TABLE pages (id  SERIAL NOT NULL, language VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, SURVEY_ID INTEGER, sort_order INTEGER, PRIMARY KEY (id));
...
CREATE TABLE questions (id  SERIAL NOT NULL, is_required BOOLEAN, language VARCHAR(255), title VARCHAR(255), type VARCHAR(255), PAGE_ID INTEGER, PARENT_ID INTEGER, SURVEY_ID INTEGER, order_in_subquestions INTEGER, order_in_survey INTEGER, PRIMARY KEY (id));
CREATE TABLE surveys (id  SERIAL NOT NULL, created_date TIMESTAMP, language VARCHAR(255), last_modified_date TIMESTAMP, DESCRIPTION VARCHAR(255), TITLE VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
...
CREATE TABLE survey_translations (id  SERIAL NOT NULL, language VARCHAR(255), DESCRIPTION VARCHAR(255), TITLE VARCHAR(255), SURVEY_ID INTEGER, PRIMARY KEY (id));
