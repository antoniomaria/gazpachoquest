...
CREATE TABLE surveys (id  SERIAL NOT NULL, description VARCHAR(255), name VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE survey_translations (id  SERIAL NOT NULL, language VARCHAR(255), text VARCHAR(255), SURVEY_ID INTEGER, PRIMARY KEY (id));
