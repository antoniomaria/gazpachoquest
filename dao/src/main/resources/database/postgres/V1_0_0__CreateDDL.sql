CREATE TABLE answers (id  SERIAL NOT NULL, code VARCHAR(255), language VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, QUESTION_ID INTEGER, order_in_question INTEGER, PRIMARY KEY (id));
...
CREATE TABLE participants (id  SERIAL NOT NULL, email VARCHAR(255), firstname VARCHAR(255), lastname VARCHAR(255), PRIMARY KEY (id));
...
CREATE TABLE surveys (id  SERIAL NOT NULL, created_date TIMESTAMP, language VARCHAR(255), last_modified_date TIMESTAMP, status VARCHAR(255), DESCRIPTION TEXT, TITLE VARCHAR(255), WELCOMETEXT TEXT, CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, PRIMARY KEY (id));
CREATE TABLE survey_runnings (id  SERIAL NOT NULL, created_date TIMESTAMP, last_modified_date TIMESTAMP, name VARCHAR(255), CREATEDBY_ID INTEGER, LASTMODIFIEDBY_ID INTEGER, SURVEY_ID INTEGER, PRIMARY KEY (id));
