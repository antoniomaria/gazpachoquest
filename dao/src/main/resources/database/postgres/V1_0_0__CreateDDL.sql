...
CREATE TABLE questions (id INTEGER NOT NULL, is_required BOOLEAN, language VARCHAR(255), title VARCHAR(255), type VARCHAR(255), PAGE_ID INTEGER, PARENT_ID INTEGER, SURVEY_ID INTEGER, order_in_subquestions INTEGER, order_in_survey INTEGER, PRIMARY KEY (id));
CREATE TABLE surveys (id INTEGER NOT NULL, description VARCHAR(255), name VARCHAR(255), PRIMARY KEY (id));
CREATE TABLE survey_runnings (id INTEGER NOT NULL, name VARCHAR(255), SURVEY_ID INTEGER, PRIMARY KEY (id));
...
CREATE SEQUENCE id_generator_sequence START WITH 1;
