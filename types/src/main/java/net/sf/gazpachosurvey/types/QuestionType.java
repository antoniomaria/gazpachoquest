...
public enum QuestionType {
    S("Single Text Box", false, false, false, String.class), L("Multiple Choice (Only One QuestionOption)", true,
            false, false, Integer.class), N("Numeric", false, false, false, Integer.class), T("Comment / Essay", false,
    ...
    /*
     * Multiple_Choice_One_Answer(false, false, true), Multiple_Choice_Multiple_Answers(false, false, true),
     * Comment(false, false, false), Rating_Scale(false, false, false), Ranking(false, false, false),
     * Matrix_of_Choices_One_Answer( false, false, false), Matrix_of_Choices_Multiple_Answers(false, false, false),
     * Matrix_of_Dropdown_Menus(false, false, false), Single_Textbox( false, false, false), Multiple_Textboxe(false,
     * false, true), Multiple_Numerical_Textboxes( false, false, true), Data_and_time(false, false, false), ;
     */
