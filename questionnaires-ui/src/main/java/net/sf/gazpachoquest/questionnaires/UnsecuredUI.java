...
public class UnsecuredUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        Label isUserInRole = new Label(String.valueOf(accessControl.isUserInRole("duke")));
        isUserInRole.setId("isUserInRole");

        Label isUserInSomeRole = new Label(String.valueOf(accessControl.isUserInSomeRole("duke")));
        isUserInSomeRole.setId("isUserInSomeRole");

        Label isUserSignedIn = new Label(String.valueOf(accessControl.isUserInSomeRole("duke")));
        isUserSignedIn.setId("isUserSignedIn");

        // specific to JAAS
        Label currentRequestNotNull = new Label(String.valueOf(JaasAccessControl.getCurrentRequest() != null));
    ...
    /**
     * Sets given component enabled if currently signed in user is in one or more given roles, otherwise component is
     * disabled.
     * 
     * This method might be moved out of {@link AccessControlUtil} in future versions.
     * 
     * @param component
     * @param roles
     */
    ...
    /**
     * Sets given component visible if currently signed in user is in one or more given roles, otherwise component is
     * hidden.
     * 
     * This method might be moved out of {@link AccessControlUtil} in future versions.
     * 
