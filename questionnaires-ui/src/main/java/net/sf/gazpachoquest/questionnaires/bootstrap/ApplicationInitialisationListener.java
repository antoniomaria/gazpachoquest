...
public class ApplicationInitialisationListener implements ServletContextListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ApplicationInitialisationListener.class);
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        startUpEvent.fire(StartUpEvent.with().properties(configProperties).build());
